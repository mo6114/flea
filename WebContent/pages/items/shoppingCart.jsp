		...
		<div id="content">
			...
			<div class="show">
				...
				<table class="table table-hover">
					...
					<s:iterator value="#session.shoppingCart">
					<tr class="good-js">
						<td><input class="check-js" type="checkbox" name="fGoodsIdList"
							value="<s:property value="id"/>"></td>
						<td class="good-img"><img src="${pageContext.request.contextPath}/uploadPicture/<s:property value = 'picture'/>"></td>
				...
				<div class="info">
					<span>已选商品<span class="num num-js">0</span>件</span>
					<span>合计￥<span class="num total-js">0</span></span>
					<button type="submit" class="btn btn-success">确认下单</button>
				</div>
				</form>
				</s:if>
				<s:else>
					<h1>您还没有添加商品到购物车，请添加商品！</h1>
				</s:else>
			</div>
