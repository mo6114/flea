	...
	<div id="huge_wraper">
		...
		<div id="content">
			...
			<div class="show">
				...
				<!--分类展示-->
				<div class="cgy-block">
					<h2>图书<a class="btn btn-link more">更多</a></h2>
					<div class="thumbnail float-title" id="item_3" data-desc="<s:property value='introduction'/>" data-amount="1">
						<img class="float-img" src="${pageContext.request.contextPath}/uploadPicture/<s:property value = 'picture'/>">
						<div class="caption">
							<h3>
							...
							<p>
								<a href="${pageContext.request.contextPath}/fOrder/insertShoppingCart?id=<s:property value='id'/>"
								   class="btn btn-warning force cart" role="button"> 加入购物车 </a>
								<a href="${pageContext.request.contextPath}/fOrder/controlBuySkip?id=<s:property value='id'/>"
				...
				<div class="cgy-block">
					<h2>服装<a class="btn btn-link more">更多</a></h2>
					<div class="thumbnail float-title" id="item_3" data-desc="<s:property value='introduction'/>" data-amount="1">
						<img class="float-img" src="${pageContext.request.contextPath}/uploadPicture/<s:property value = 'picture'/>">
						<div class="caption">
							<h3>
				...
				<div class="cgy-block">
					<h2>电子产品<a class="btn btn-link more">更多</a></h2>
					<div class="thumbnail float-title" id="item_3" data-desc="<s:property value='introduction'/>" data-amount="1">
						<img class="float-img" src="${pageContext.request.contextPath}/uploadPicture/<s:property value = 'picture'/>">
						<div class="caption">
							<h3>
				...
				<div class="cgy-block">
					<h2>其它<a class="btn btn-link more">更多</a></h2>
					<div class="thumbnail float-title" id="item_3" data-desc="<s:property value='introduction'/>" data-amount="1">
						<img class="float-img" src="${pageContext.request.contextPath}/uploadPicture/<s:property value = 'picture'/>">
						<div class="caption">
							<h3>
