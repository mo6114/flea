...
<div class="left-side">
	...
	<ul class="nav nav-pills nav-stacked">
		<li><a class="listTitle" href="#">我的资料</a></li>
		<li class="dropdown"><a class="listTitle" href="#">我是买家</a>
			<ul class="menue">
				<li class="line-i" role="presentation"><a role="menuitem" tabindex="-1"
					href="${pageContext.request.contextPath}/fOrder/queryByStatusForBuyer?status=1">我的订单</a></li>
				<!-- <li role="presentation"><a role="menuitem" tabindex="-1"
					href="#">参加的拍卖</a></li> -->
			</ul></li>
		<li><a class="listTitle" href="#">我是卖家</a>
			<ul class="menue">
				<li class="line-i" role="presentation"><a role="menuitem" tabindex="-1"
