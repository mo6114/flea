        ...
        <ul class="nav nav-pills nav-stacked">
            ...
            <li class="dropdown">
                ...
                <ul class="menue">
                    ...
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="#">参加的拍卖</a>
                    </li>
                </ul>
            </li>
            <li class="active">
                ...
                <ul class="menue">
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="#">上架新商品</a>
                    </li>
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="#">已上架商品</a>
                    </li>
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="#">我的订单</a>
                    </li>
                    <li role="presentation">
                        <a role="menuitem" tabindex="-1" href="#">我的拍卖</a>
                    </li>
                </ul>
            </li>
        </ul>
...
<div id="glo-login-cover">
    <div id="glo-login-wraper">
        ...
        <div class="login-form-area" data-typ="signin">
            <div class="line">
                <input type="text" class="username" name="username" placeholder="用户名/电子邮箱"><br>
            </div>
            <div class="line">
